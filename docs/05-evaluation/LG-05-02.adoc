...
** Revisionshistorie, wie z.{nbsp}B. die Änderungsrate pro Komponente (R3)
...
// tag::EN[]
[[LG-05-02]]
==== LG 05-02: Analyze the Qualities of a Software System (R1, R3)
