...
* Zusammenhang mit Geschäfts- und Betriebsprozessen für beispielsweise Informationssysteme und Entscheidungsunterstützungssysteme (Data Warehouse, Management Information Systems) oder andere Arten von Systemen herstellen.
