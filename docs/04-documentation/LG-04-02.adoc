...
* sorgen für Konsistenz zwischen mündlicher und schriftlicher Kommunikation und wägen beide angemessen gegeneinander ab

Softwarearchitekt:innen wissen (R1):

* den Nutzen von Template-basierter Dokumentation
* dass verschiedene Eigenschaften der Dokumentation von Spezifika des Systems, seinen Anforderungen, Risiken, dem Entwicklungsvorgehen, der Organisation oder anderen Faktoren abhängen.
...
// tag::EN[]
[[LG-04-02]]
==== LG 04-02: Describe and Communicate Software Architectures (R1-R3)
...
* support consistency of written and verbal communication, and balance one against the other appropriately
