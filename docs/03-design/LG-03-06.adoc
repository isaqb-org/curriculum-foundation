...
[[LG-03-06]]
==== LZ 03-06: Abhängigkeiten von Bausteinen managen (R1)
...
{glossary_url}dependency-injection[Dependency Injection] (R1) (siehe auch <<LG-03-08>>).
...
// tag::EN[]
[[LG-03-06]]
==== LG 03-06: Manage Dependencies between Building Blocks (R1)
...
{glossary_url}dependency-injection[Dependency Injection] (R1) (see also <<LG-03-08>>).
