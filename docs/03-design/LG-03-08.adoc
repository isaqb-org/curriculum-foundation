...
// tag::DE[]
[[LG-03-08]]
==== LZ 03-08 [ehemaliges LZ 2-5]: Wichtige Muster beschreiben, erklären und angemessen anwenden (R1, R3)
...
==== LG 03-08 [previously LG 2-5]: Describe, Explain and Apply Important Patterns (R1, R3)
