...
// tag::DE[]
[[LG-03-08]]
==== LZ 03-08 [ehemaliges LZ 2-5]: Wichtige Entwurfsmuster beschreiben, erklären und angemessen anwenden (R1, R3)

Softwarearchitekt:innen können die folgenden Entwurfsmuster erklären und Beispiele dafür liefern (R1):
...
==== LG 03-08 [previously LG 2-5]: Describe, Explain and Apply Important Design Patterns (R1, R3)

Software architects can explain and provide examples for the following design patterns (R1):
