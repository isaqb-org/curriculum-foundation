...
[[LG-03-04]]
==== LZ 03-04: Entwurfsprinzipien erläutern und anwenden (R1-R3)
...
* Trennung von Belangen ({glossary_url}separation-of-concern[Separation of Concerns] - SoC)
...
**Reduktion von Komplexität** (R2-R3)

* als Motiv der Prinzipien KISS, YAGNI und CUPID <<north-cupid>> (R3)
* DRY (Don't Repeat Yourself) als eine Möglichkeit, Wiederholungen zu vermeiden  (R2)
...
**{glossary_url}make-illegal-states-unrepresentable[Make illegal states unrepresentable]** (R2)

* als ein Entwurfsprinzip, um die Robustheit verbessern
...
[[LG-03-04]]
==== LG 03-04: Explain and Use Design Principles (R1-R3)
...
**Complexity reduction** (R2-R3)

* as the driving factor behind KISS, YAGNI, and CUPID <<north-cupid>> (R3)
* DRY (Don't Repeat Yourself) as one option to avoid repetitions (R2)
...
* as a design principle to improve robustness
