...
// tag::DE[]
[[LZ-03-07]]
==== LZ 03-07 [ehemaliges LZ 2-05]: Wichtige Lösungsmuster beschreiben, erklären und angemessen anwenden (R1, R3)
...
// tag::EN[]
[[LG-03-07]]
==== LG 03-07 [previously LG 2-05]: Describe, Explain and Appropriately Apply Important Solution Patterns (R1, R3)
