...
// tag::DE[]
[[LZ-03-01]]
==== LZ 03-01 [ehemaliges LZ 2-01]: Vorgehen und Heuristiken zur Architekturentwicklung auswählen und anwenden können (R1,R3)
...
// tag::EN[]
[[LG-03-01]]
==== LG 03-01 [previously LG 2-01]: Select and Use Approaches and Heuristics for Architecture Development (R1,R3)
