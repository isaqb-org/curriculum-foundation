...
[[LZ-03-10]]
==== LZ 03-10 [ehemaliges LZ 2-10]: Grundlegende Prinzipien von Software-Deployments kennen (R3)
...
[[LG-03-10]]
==== LG 03-10 [previously LG 2-10]: Know Fundamental Principles of Software Deployment (R3)
