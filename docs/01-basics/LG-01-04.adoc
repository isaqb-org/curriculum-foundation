...
* Softwarearchitektur auf Basis von Sichten, Mustern sowie technischen und Querschnittsthemen kommunizieren und dokumentieren
...
* communicate and document software architecture based on views, patterns, cross-cutting concerns, and technical concerns
