...
For each learning goal, relevance for the examination of this learning goal or its sub-elements is clearly stated (by the R-1/R-2/R-3 classification, see table).
...
In certification examinations, the iSAQB may check these prerequisites by appropriate questions
