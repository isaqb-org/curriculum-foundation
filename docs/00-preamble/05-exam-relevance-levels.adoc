...
| R1
| Können
| Diese Inhalte sollen die Teilnehmenden nach der Schulung selbstständig anwenden können. Innerhalb der Schulung sollten diese Inhalte durch Übungen und Diskussionen abgedeckt werden.
...
| R1
| Being able to 
| These are the contents participants will be expected to be able to put into practice independently upon completion of the course. Within the course, these contents shall be covered through exercises and discussions.
