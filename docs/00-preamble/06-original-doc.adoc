...
Den aktuellen Stand dieses Dokumentes finden Sie auf der offiziellen https://public.isaqb.org/curriculum-foundation/[Download-Seite] unter https://public.isaqb.org/.
...
You find the most current version of this document on the official https://public.isaqb.org/curriculum-foundation/[download page] on https://public.isaqb.org/.
