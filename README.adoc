...
== Status
image:https://github.com/isaqb-org/curriculum-foundation/actions/workflows/build_main.yml/badge.svg?branch=main["CI – Releases and Main"]
...
==== `/build`
Contains the files generated by the build process.
...
See link:license-copyright/LICENSE.adoc[the license] and link:license-copyright/copyright.adoc[copyright] for details.
