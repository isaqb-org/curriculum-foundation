...
* **(upcoming) version 2025 (will become mandatory from April 1^st^ 2023)**
...
| for 2025, CRs are accepted until May 31st 2024
a| 2  | We hope to get (anonymous) statistical evaluation of examinations and examination questions from certification providers.  | continuously | none
